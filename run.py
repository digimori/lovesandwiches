...
#Refactored functions from update_surplus and update_sales_worksheet:
...
def calculate_avg_stock(data):
    new_stock_data = []
    for column in data:
        integercolumn = [int(num) for num in column]
        average = sum(integercolumn) / len(integercolumn)
...
def main():
    ...
    stock_data = calculate_avg_stock(sales_columns)
